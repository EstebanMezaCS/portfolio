...
const Portfolio = () => {
  ...
  const translations = {
    en: {
      ...
      about: {
        title: 'About Me',
        description: "I'm a Backend Developer and Blockchain enthusiast with 2.5+ years of experience building robust systems and decentralized applications. Currently pursuing my BS in Computer Science (graduating 2028), I specialize in creating scalable backend architectures and smart contracts.",
        ...
        {Object.entries(t.nav).map(([key, value]) => (
          <a
            ...
            onMouseEnter={(e) => {
              ...
              if (mode === 'cyber') e.target.style.textShadow = `0 0 10px ${theme.accent}`;
            }}
            onMouseLeave={(e) => {
      ...
      <div style={{ display: 'flex', gap: '15px', alignItems: 'center' }}>
        ...
        {mode === 'cyber' && (
          <button
            ...
            style={{
              background: musicPlaying ? theme.accent : theme.bgTertiary,
              border: `1px solid ${theme.border}`,
              color: musicPlaying ? '#000' : theme.text,
              padding: '8px 12px',
              borderRadius: '6px',
              cursor: 'pointer',
              fontSize: '14px',
    ...
    <section style={{
      ...
      <a
        ...
        style={{
          ...
          transition: 'all 0.3s ease',
          fontFamily: mode === 'cyber' ? "'Orbitron', monospace" : "'Space Grotesk', sans-serif",
          boxShadow: mode === 'cyber' ? `0 0 20px ${theme.accentGlow}` : '0 4px 20px rgba(59, 130, 246, 0.3)'
        }}
        onMouseEnter={(e) => {
          if (mode === 'cyber') {
            e.target.style.background = theme.accent;
            e.target.style.color = '#000';
            e.target.style.boxShadow = `0 0 30px ${theme.accent}`;
          }
        }}
        onMouseLeave={(e) => {
          if (mode === 'cyber') {
            ...
            e.target.style.color = theme.accent;
            e.target.style.boxShadow = `0 0 20px ${theme.accentGlow}`;
          }
        }}
      >
        {t.hero.cta}
    ...
    <section id="about" style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          borderRadius: '16px',
          border: `1px solid ${theme.border}`,
          boxShadow: mode === 'cyber' ? `0 0 30px ${theme.accent}10` : '0 4px 20px rgba(0,0,0,0.2)'
        }}>
          <p style={{
            color: theme.textSecondary,
            fontSize: '18px',
        ...
        {t.projects.items.map((project, i) => (
          <div
            ...
            onMouseEnter={(e) => {
              ...
              if (mode === 'cyber') {
                e.currentTarget.style.boxShadow = `0 10px 40px ${theme.accent}20`;
                e.currentTarget.style.borderColor = theme.accent;
              } else {
            ...
            <div style={{
              ...
              {project.tech.map((tech, j) => (
                <span
                  ...
                  style={{
                    padding: '6px 12px',
                    background: mode === 'cyber' ? `${theme.accent}15` : `${theme.accent}10`,
                    color: theme.accent,
                    borderRadius: '6px',
                    fontSize: '12px',
                    fontWeight: '500',
        ...
        {[
          ...
          <a
            ...
            onMouseEnter={(e) => {
              ...
              if (mode === 'cyber') {
                e.currentTarget.style.boxShadow = `0 0 15px ${theme.accentGlow}`;
              }
            }}
            onMouseLeave={(e) => {
              e.currentTarget.style.borderColor = theme.border;
